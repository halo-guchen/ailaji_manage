...
import com.ailaji.manage.jdbc.persistence.utils.UUIDUtils;
...
public class SqlUtils {
    ...
    public static BoundSql buildUpdateSql(Object entity, Criteria criteria, NameHandler nameHandler) {
        ...
        while (iterator.hasNext()) {
            ...
            if(StringUtils.equalsIgnoreCase("last_modified_time", columnName)){
            	continue;
            }
...
/*            if (value instanceof String && StringUtils.isBlank(value.toString())) {
     ...
     * @return
     */
    public static Object getReadMethodValue(Method readMethod, Object entity) {
        if (readMethod == null) {
            return null;
        }
        try {
