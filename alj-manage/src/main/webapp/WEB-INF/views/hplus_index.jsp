    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/images/profile_small.jpg" /></span>
                    ...
                    <li>
                        <a class="J_menuItem" href="mainPage" data-index="0"><i class="fa fa-home"></i> <span class="nav-label">主页</span></a>
                    </li>
                    <li>
                        <a href="#">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                               <a class="J_menuItem" href="${pageContext.request.contextPath}/private/user/page">用户管理<span class="label label-danger pull-right">重要</span></a>
                            </li>
                            <li>
                               <a class="J_menuItem" href="${pageContext.request.contextPath}/private/user/resource/page">资源文件<span class="label label-danger pull-right">重要</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="http://www.baidu.com">
                            <div class="form-group">
                                <input type="text" placeholder="请输入您需要查找的内容 …" class="form-control" name="wd" id="top-search">
                            </div>
                        </form>
                    </div>
                                ...
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/images/a7.jpg">
                                        </a>
                                        <div class="media-body">
                                            <strong>小四</strong> 这个在日本投降书上签字的军官，建国后一定是个不小的干部吧？
                                            <br>
                                            <small class="text-muted">2014.11.8</small>
                                        </div>
                                    </div>
                                </li>
                                <li class="divider"></li>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="tagCloud" frameborder="0" data-id="mainPage" seamless></iframe>
            </div>
            <!-- 中间内容部分结束 -->
            
            <!-- 页脚内容部分开始 -->
            <div class="footer">
                <div class="pull-right">&copy; 2015-2016 <a href="http://www.baidu.com/" target="_blank">友情链接</a>
                </div>
            </div>
            <!-- 页脚内容部分结束 -->
        </div>
