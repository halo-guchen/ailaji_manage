 ...
 */!function(e) {
        ...
        if (n() || i(9)) {
            ...
            this.each(function() {
                var i = e(this)
                  , n = i.data("fileinput")
                  , r = "object" == typeof t && t;
                n || (n = new H(this,e.extend({}, e.fn.fileinput.defaults, r, e(this).data())),
                i.data("fileinput", n)),
                "string" == typeof t && n[t].apply(n, a)
            })
        }
    }
    ,
    ...
    e.fn.fileinput.locales = {},
    e.fn.fileinput.locales.en = {
        fileSingle: "file",
        filePlural: "files",
    ...
    e.extend(e.fn.fileinput.defaults, e.fn.fileinput.locales.en),
